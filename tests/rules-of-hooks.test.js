...
const tests = {
  ...
  invalid: [
    ...
    {
      code: normalizeIndent`
        // invalid valid because it's not matching the PascalCase namespace
        jest.useFakeTimer()
      `,
      errors: [topLevelError('jest.useFakeTimer')],
    },
    {
      code: normalizeIndent`
        // Invalid -- this is a regression test.
        jest.useFakeTimers();
        beforeEach(() => {
          jest.useRealTimers();
        })
