...
tests.describe('use no memo directive', () => {
  tests.addValid(
    'rule is disabled when file has use no memo directive',
    `
      'use no memo';
  ...
  tests.addValid(
    'rule is disabled with use no memo even with compiler directive comment',
    `
      'use no memo';
      // eslint react-compiler/react-compiler: ["error"]
  ...
  tests.addValid(
    'rule is disabled for disallowed methods with use no memo',
    `
      'use no memo';
      // eslint react-compiler/react-compiler: ["error"]
